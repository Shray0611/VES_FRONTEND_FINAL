          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
              ...
              <div className="flex justify-between items-center mt-6">
                ...
                <button className="bg-white text-[#5f4b32] border border-[#5f4b32] hover:bg-gray-50 px-4 py-2 rounded-lg font-medium transition-colors">
                  + Add New
                </button>
              </div>
            </div>

            {/* Enhanced Students Registered */}
            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-semibold text-gray-800">
                  Students Registered
              ...
              <ul className="space-y-3">
                {[
                  ...
                  >
                    ...
                    <button className="bg-[#5f4b32] hover:bg-[#4a3a27] text-white px-3 py-1 rounded-lg text-sm font-medium transition-colors">
              ...
              <div className="mt-6">
                <button className="bg-[#5f4b32] hover:bg-[#4a3a27] text-white px-4 py-2 rounded-lg font-medium w-full transition-colors">
                  View Analytics
                </button>
              </div>
            </div>
